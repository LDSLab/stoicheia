...
impl Patch {
    ...
    pub fn autogenerate(pattern: ContentPattern, size: usize) -> Patch {
        use ContentPattern::*;
...
/// Fill patterns used for autogenerated patches
pub enum ContentPattern {
    /// Filled with NaN
    Empty,
    /// Filled with 0
    Zero,
    /// Filled with uniform random numbers
    Random,
    /// 0.1% filled with uniform random numbers in a field of zeros
    Sparse,
}
